package net.sourceforge.omov.core.gui.smartcopy;
...
import net.sourceforge.omov.core.gui.comp.generic.MacLikeTable;
import net.sourceforge.omov.core.gui.main.MainWindowController;
