...
import net.sourceforge.omov.core.gui.comp.generic.ITableSelectionListener;
import net.sourceforge.omov.core.gui.comp.generic.brushed.BrushedMetalPanel;
import net.sourceforge.omov.core.gui.main.tablex.IMovieTableContextMenuListener;
import net.sourceforge.omov.core.gui.main.tablex.MovieTableModel;
import net.sourceforge.omov.core.gui.main.tablex.MovieTableX;
import net.sourceforge.omov.core.gui.smartfolder.SmartFolderSelectionPanel;
