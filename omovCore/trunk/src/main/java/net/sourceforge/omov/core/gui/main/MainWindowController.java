...
import net.sourceforge.omov.core.App;
...
import net.sourceforge.omov.core.gui.AboutDialog;
import net.sourceforge.omov.core.gui.CommonController;
import net.sourceforge.omov.core.gui.IPrevNextMovieProvider;
import net.sourceforge.omov.core.gui.doubletten.DuplicatesFinderProgressDialog;
import net.sourceforge.omov.core.gui.export.BackupImportDialog;
import net.sourceforge.omov.core.gui.export.ExporterChooserDialog;
import net.sourceforge.omov.core.gui.movie.AddEditMovieDialog;
import net.sourceforge.omov.core.gui.movie.EditMoviesDialog;
import net.sourceforge.omov.core.gui.preferences.PreferencesWindow;
import net.sourceforge.omov.core.gui.scan.ScanDialog;
import net.sourceforge.omov.core.gui.smartcopy.SmartCopyDialog;
