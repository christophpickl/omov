...
import net.sourceforge.omov.core.gui.SetupWizard;
import net.sourceforge.omov.core.gui.SplashScreen;
import net.sourceforge.omov.core.gui.main.MainWindow;
import net.sourceforge.omov.core.gui.preferences.VersionCheckDialog;
