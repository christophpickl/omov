...
import at.ac.tuwien.e0525580.omov2.gui.CommonController;
import at.ac.tuwien.e0525580.omov2.gui.IPrevNextMovieProvider;
import at.ac.tuwien.e0525580.omov2.gui.SmartCopyDialog;
import at.ac.tuwien.e0525580.omov2.gui.export.ExporterChooserDialog;
import at.ac.tuwien.e0525580.omov2.gui.movie.AddEditMovieDialog;
import at.ac.tuwien.e0525580.omov2.gui.movie.EditMoviesDialog;
import at.ac.tuwien.e0525580.omov2.gui.preferences.PreferencesWindow;
import at.ac.tuwien.e0525580.omov2.gui.scan.ScanDialog;
import at.ac.tuwien.e0525580.omov2.model.IMovieDao;
import at.ac.tuwien.e0525580.omov2.tools.remote.IRemoteDataReceiver;
import at.ac.tuwien.e0525580.omov2.tools.remote.RemoteServer;
import at.ac.tuwien.e0525580.omov2.util.CoverUtil;
        ...
        if(dialog.isActionConfirmed() == true) {
            ...
            try {
                for (Movie movieToEdit : moviesToEdit) {
                    ...
                    final int quality           = dialog.isFieldSelected(MovieField.QUALITY)    ? confirmedMovie.getQuality()    : movieToEdit.getQuality();
