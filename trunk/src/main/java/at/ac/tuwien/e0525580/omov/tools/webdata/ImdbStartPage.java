...
class ImdbStartPage extends NodeVisitor {
    ...
    private static void debug(String msg) {
        if(WebImdbExtractor.DEBUG) System.out.println("ImdbStartPage: " + msg);
    }
    ...
    // FEATURE zuerst "Popular Titles" anzeigen, dann andere
...
//        debug("visiting tag '"+tag.getTagName()+"'.");
        ...
        final WebSearchResult searchResult = new WebSearchResult(linkLabel, WebImdbExtractor.HOST + href);
