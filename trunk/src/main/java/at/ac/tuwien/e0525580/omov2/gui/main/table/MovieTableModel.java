...
import at.ac.tuwien.e0525580.omov2.gui.comp.generic.table.IColumnComparable;
import at.ac.tuwien.e0525580.omov2.gui.comp.generic.table.VisibleTableColumn;
import at.ac.tuwien.e0525580.omov2.gui.comp.generic.table.WidthedTableColumn;
import at.ac.tuwien.e0525580.omov2.gui.comp.rating.RatingField;
import at.ac.tuwien.e0525580.omov2.model.IMovieDao;
import at.ac.tuwien.e0525580.omov2.model.IMovieDaoListener;
...
//            }});
        ...
        columns.add(new MovieColumn(MovieField.QUALITY, 60, 60, 60, true) {
            ...
            public Class<?> getValueClass() {  return String.class;  }
            public int compareValue(Movie m1, Movie m2) {
                int q1 = m1.getQuality(); int q2 = m2.getQuality();
