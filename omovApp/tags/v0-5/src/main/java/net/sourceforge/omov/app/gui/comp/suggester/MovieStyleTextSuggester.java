 ...
 */
public class MovieStyleTextSuggester extends AbstractTextSuggester {
    ...
    public MovieStyleTextSuggester(final int columns) {
        super(columns);
    }

    @Override
    protected List<String> getValues() {
        return MovieStyleTextSuggester.model.getValues();
    }
